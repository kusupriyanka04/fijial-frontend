...
export default function Navbar() {
  ...
  return (
    <nav className="bg-zomato text-white px-6 py-4 flex justify-between items-center">
      ...
      <div className="hidden md:flex space-x-4 items-center">
        ...
        {token && (
          <button
            ...
            className="bg-white text-zomato px-3 py-1 rounded font-semibold hover:bg-gray-100 transition"
          >
            Logout
          </button>
        )}
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="absolute top-16 right-4 bg-white text-black rounded shadow-md flex flex-col p-4 space-y-2 md:hidden z-50">
